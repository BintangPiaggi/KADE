...
class LeaguePrevious : Fragment(), MatchView {
    ...
    companion object {
        fun newInstance(leagueId: String): LeaguePrevious {
            val fragment = LeaguePrevious()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_league_previous, container, false)
        val rv = view.findViewById<RecyclerView>(R.id.rcLeaguePrev)
        pb = view.findViewById(R.id.pbLeaguePrev)
